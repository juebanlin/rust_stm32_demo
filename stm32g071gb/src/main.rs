...
use stm32g0xx_hal::{cortex_m, stm32 as device, stm32};
...
use stm32g0xx_hal::gpio::{OpenDrain, Output, PB6, PB7, Speed};
...
use stm32g071gb::bq40z50r2::{Address, BQ40Z50, Cmd};
...
fn smbus_demo()->!{
    ...
    let mut cfg =Config::new(Hertz::kHz(400));
    // cfg.speed.insert(Hertz::kHz(100));
    // cfg.slave_address( Address::Dev as u8);
    dp.I2C1.cr1.modify(|_,w|w.smbhen().clear_bit());
    dp.I2C1.cr1.modify(|_,w|w.smbden().clear_bit());
    dp.I2C1.cr1.modify(|_,w|w.nackie().clear_bit());
